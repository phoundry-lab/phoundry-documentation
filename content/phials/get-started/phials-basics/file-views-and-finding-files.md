---
title: "File views and finding files"
description: "Understand file views, sorting, filtering, grouping, and search before choosing detailed controls."
icon: phoundry-mono:learn
order: 3
ai_disclosure: true
---
...
Each Explorer tab owns its live view state. The same folder can therefore appear as Details in one tab and Grid in another. Use [Configure a file view](../../browse-and-manage-files/choose-and-configure-file-views/configure-a-file-view.md) when you need to change the mode, visible properties, item sizing, or other view options.
...
See [Sort files](../../browse-and-manage-files/find-and-narrow-files/sort-files.md), [Filter files](../../browse-and-manage-files/find-and-narrow-files/filter-files.md), [Group files](../../browse-and-manage-files/find-and-narrow-files/group-files.md), and [Search filenames and file contents](../../browse-and-manage-files/find-and-narrow-files/search-filenames-and-file-contents.md) for the complete controls. To reuse a configured presentation, see [Create and switch saved views](../../organize-files-with-phials/save-and-reuse-views/create-and-switch-saved-views.md).
