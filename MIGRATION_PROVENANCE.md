...
| Phoundry UI implementation target | `phoundry-lab/phoundry-ui` | `0b3fa2c` | package source | Exact clean-worktree package artifact is committed at `vendor/phoundry-ui-0b3fa2c.tgz`; this commit adds package preparation without changing component source |
